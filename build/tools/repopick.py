...
if __name__ == '__main__':
    # Default to FuliaUI Gerrit
    default_gerrit = 'https://review.fuliaui.com'
    ...
    for project in projects:
        name = ("Diverse-Techs-Circle/")+project.get('name')
    ...
    for item in mergables:
        ...
        if args.gerrit == default_gerrit:
            ...
            if args.pull:
                cmd = ['git pull --no-edit fulia', item['fetch'][method]['ref']]
            else:
                cmd = ['git fetch fulia', item['fetch'][method]['ref']]
            if args.quiet:
                cmd.append('--quiet')
            else:
                print(cmd)
